...
class ActivityModel extends CI_Model{
    ...
    public function createActivity($post){
        ...
        $sql = 'INSERT INTO activity (act_name, act_description, act_resume, act_is_special_offer, act_description_special_offer,act_participant_nb, act_monitor_nb, act_operator_nb, act_duration, act_base_price, act_required_age, act_street, act_city, act_zipcode, act_country, act_created_at, act_updated_at, act_status, cat_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
    ...
    public function updateActivity($post){
        ...
        $sql = 'UPDATE activity SET act_name = ?, act_description = ?, act_resume = ?, act_is_special_offer = ?, act_description_special_offer = ?, act_participant_nb = ?, act_monitor_nb = ?, act_operator_nb = ?, act_duration = ?, act_base_price = ?, act_required_age = ?, act_street = ?, act_city = ?, act_zipcode = ?, act_country = ?, act_updated_at = ?, act_status = ?, cat_id = ? WHERE act_id = ?';
